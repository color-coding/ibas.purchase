	...
	protected IBusinessRule[] registerRules() {
		return new IBusinessRule[] {
				...
				new BusinessRuleSumElements(PROPERTY_ITEMSLINETOTAL, PROPERTY_PURCHASEINVOICEITEMS,
						PurchaseInvoiceItem.PROPERTY_LINETOTAL),
				// 计算行-税总计
				new BusinessRuleSumElements(PROPERTY_ITEMSTAXTOTAL, PROPERTY_PURCHASEINVOICEITEMS,
						PurchaseInvoiceItem.PROPERTY_TAXTOTAL),
				// 计算运输-费用总计（含税）
