 ...
 * 
 */
public interface IPurchaseReturnRequest extends IBODocument, IShippingAddressParent {
	 ...
	 * @return 值
	 */
	IPurchaseReturnRequestItems getPurchaseReturnRequestItems();
	 ...
	 * @param value 值
	 */
	void setPurchaseReturnRequestItems(IPurchaseReturnRequestItems value);
