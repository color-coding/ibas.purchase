...
public class PurchaseReserveInvoice extends BusinessObject<PurchaseReserveInvoice>
	 ...
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PurchaseReserveInvoice.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_PH_ORIV";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PurchaseReserveInvoice";
	 ...
	 * 取消日期 属性
	 */
	@DbField(name = "CnclDate", type = DataType.DATE, table = DB_TABLE_NAME)
	 ...
	 * 
	 */
	public static final IPropertyInfo<IPurchaseReserveInvoiceItems> PROPERTY_PURCHASERESERVEINVOICEITEMS = registerProperty(
			PROPERTY_PURCHASERESERVEINVOICEITEMS_NAME, IPurchaseReserveInvoiceItems.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElementWrapper(name = PROPERTY_PURCHASERESERVEINVOICEITEMS_NAME)
	@XmlElement(name = PurchaseReserveInvoiceItem.BUSINESS_OBJECT_NAME, type = PurchaseReserveInvoiceItem.class)
	public final IPurchaseReserveInvoiceItems getPurchaseReserveInvoiceItems() {
		return this.getProperty(PROPERTY_PURCHASERESERVEINVOICEITEMS);
	}
	 ...
	 * @param value 值
	 */
	public final void setPurchaseReserveInvoiceItems(IPurchaseReserveInvoiceItems value) {
		this.setProperty(PROPERTY_PURCHASERESERVEINVOICEITEMS, value);
	}
	...
	protected void initialize() {
		...
		this.setPurchaseReserveInvoiceItems(new PurchaseReserveInvoiceItems(this));
	...
	protected void reset() {
		...
		this.setDocumentStatus(emDocumentStatus.RELEASED);
		this.getPurchaseReserveInvoiceItems().forEach(c -> c.setLineStatus(emDocumentStatus.RELEASED));
	}
		...
		return new IBusinessLogicContract[] {
				...
				new ISupplierCheckContract() {
					...
					public String getIdentifiers() {
						return PurchaseReserveInvoice.this.getIdentifiers();
					}
				...
				new IBranchCheckContract() {
					...
					public String getBranch() {
						return PurchaseReserveInvoice.this.getBranch();
					}
				},
				// 创建分录
				new IJournalEntryCreationContract() {
					...
					public String getBaseDocumentType() {
						return PurchaseReserveInvoice.this.getObjectCode();
					}

					@Override
					public Integer getBaseDocumentEntry() {
						return PurchaseReserveInvoice.this.getDocEntry();
					}
					...
					public String getReference1() {
						return PurchaseReserveInvoice.this.getReference1();
					}

					@Override
					public String getReference2() {
						return PurchaseReserveInvoice.this.getReference2();
					}
					...
					public JournalEntryContent[] getContents() {
						...
						// 单据折扣不是1
						if (!Decimals.VALUE_ONE.equals(PurchaseReserveInvoice.this.getDiscount())) {
							for (JournalEntryContent item : jeContents) {
								...
								if (Ledgers.LEDGER_INVENTORY_INVENTORY_ACCOUNT.equals(item.getLedger())
									...
									item.setAmount(Decimals.multiply(item.getAmount(),
