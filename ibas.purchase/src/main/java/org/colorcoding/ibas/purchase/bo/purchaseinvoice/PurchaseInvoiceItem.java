...
@XmlType(name = PurchaseInvoiceItem.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class PurchaseInvoiceItem extends BusinessObject<PurchaseInvoiceItem> implements IPurchaseInvoiceItem,
		IBusinessLogicsHost, IBOTagDeleted, IBOTagCanceled, IBOUserFields, IJECPropertyValueGetter {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -6469666774314804057L;
	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PurchaseInvoiceItem.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_PH_INV1";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PurchaseInvoiceItem";
	 ...
	 * 产品/服务描述 属性
	 */
	@DbField(name = "Dscription", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 产品标识 属性
	 */
	@DbField(name = "ItemSign", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 目录编码 属性
	 */
	@DbField(name = "CatalogCode", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 物料版本 属性
	 */
	@DbField(name = "ItemVer", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 单位 属性
	 */
	@DbField(name = "UOM", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 库存单位 属性
	 */
	@DbField(name = "InvUOM", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 单位换算率 属性
	 */
	@DbField(name = "UOMRate", type = DataType.DECIMAL, editType = EditType.RATE, table = DB_TABLE_NAME)
	 ...
	 * 库存数量 属性
	 */
	@DbField(name = "InvQty", type = DataType.DECIMAL, editType = EditType.QUANTITY, table = DB_TABLE_NAME)
	 ...
	 * 价格 属性
	 */
	@DbField(name = "Price", type = DataType.DECIMAL, editType = EditType.PRICE, table = DB_TABLE_NAME)
	 ...
	 * 行总计 属性
	 */
	@DbField(name = "LineTotal", type = DataType.DECIMAL, editType = EditType.SUM, table = DB_TABLE_NAME)
	 ...
	 * 行折扣 属性
	 */
	@DbField(name = "DiscPrcnt", type = DataType.DECIMAL, editType = EditType.PERCENTAGE, table = DB_TABLE_NAME)
	 ...
	 * 折扣前价格 属性
	 */
	@DbField(name = "UnitPrice", type = DataType.DECIMAL, editType = EditType.PRICE, table = DB_TABLE_NAME)
	 ...
	 * 折扣前行总计 属性
	 */
	@DbField(name = "UnitTotal", type = DataType.DECIMAL, editType = EditType.SUM, table = DB_TABLE_NAME)
	 ...
	 * 税定义 属性
	 */
	@DbField(name = "Tax", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 税率 属性
	 */
	@DbField(name = "TaxRate", type = DataType.DECIMAL, editType = EditType.RATE, table = DB_TABLE_NAME)
	 ...
	 * 税总额 属性
	 */
	@DbField(name = "TaxTotal", type = DataType.DECIMAL, editType = EditType.SUM, table = DB_TABLE_NAME)
	 ...
	 * 税前价格 属性
	 */
	@DbField(name = "PreTaxPrice", type = DataType.DECIMAL, editType = EditType.PRICE, table = DB_TABLE_NAME)
	 ...
	 * 税前行总计 属性
	 */
	@DbField(name = "PreTaxTotal", type = DataType.DECIMAL, editType = EditType.SUM, table = DB_TABLE_NAME)
	 ...
	 * 合同 属性
	 */
	@DbField(name = "Agreements", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 反向行折扣 属性
	 */
	@DbField(name = "InDiscPrcnt", type = DataType.DECIMAL, editType = EditType.PERCENTAGE, table = DB_TABLE_NAME)
	 ...
	 * 价格（本币） 属性
	 */
	@DbField(name = "PriceLC", type = DataType.DECIMAL, editType = EditType.PRICE, table = DB_TABLE_NAME)
	 ...
	 * 折扣前价格（本币） 属性
	 */
	@DbField(name = "UnitPriceLC", type = DataType.DECIMAL, editType = EditType.PRICE, table = DB_TABLE_NAME)
	 ...
	 * 税前价格（本币） 属性
	 */
	@DbField(name = "PreTaxPriceLC", type = DataType.DECIMAL, editType = EditType.PRICE, table = DB_TABLE_NAME)
	...
	public IBusinessLogicContract[] getContracts() {
		...
		contracts.add(new ITaxGroupCheckContract() {
			...
			public String getTax() {
				return PurchaseInvoiceItem.this.getTax();
			}

			@Override
			public BigDecimal getTaxRate() {
				return PurchaseInvoiceItem.this.getTaxRate();
			}
		});
		// 物料及仓库检查
		contracts.add(new IMaterialWarehouseCheckContract() {
			...
			public emYesNo getBatchManagement() {
				return PurchaseInvoiceItem.this.getBatchManagement();
			}
		...
		if (!MyConfiguration.applyVariables(PurchaseDelivery.BUSINESS_OBJECT_CODE)
			...
			contracts.add(new IMaterialReceiptContract() {
				...
				public boolean isOffsetting() {
					...
					if (PurchaseInvoiceItem.this instanceof IBOTagDeleted) {
						IBOTagDeleted boTag = (IBOTagDeleted) PurchaseInvoiceItem.this;
					...
					if (PurchaseInvoiceItem.this.parent instanceof IBOTagDeleted) {
						IBOTagDeleted boTag = (IBOTagDeleted) PurchaseInvoiceItem.this.parent;
						if (boTag.getDeleted() == emYesNo.YES) {
							return true;
						}
					}
					if (PurchaseInvoiceItem.this.parent instanceof IApprovalData) {
						IApprovalData apData = (IApprovalData) PurchaseInvoiceItem.this.parent;
				...
				public String getItemName() {
					return PurchaseInvoiceItem.this.getItemDescription();
				}
				...
				public String getDocumentType() {
					return PurchaseInvoiceItem.this.getObjectCode();
				}

				@Override
				public Integer getDocumentEntry() {
					return PurchaseInvoiceItem.this.getDocEntry();
				}

				@Override
				public Integer getDocumentLineId() {
					return PurchaseInvoiceItem.this.getLineId();
				}

				@Override
				public BigDecimal getQuantity() {
					return PurchaseInvoiceItem.this.getInventoryQuantity();
				}

				@Override
				public String getUOM() {
					return PurchaseInvoiceItem.this.getInventoryUOM();
				}

				@Override
				public DateTime getPostingDate() {
					return PurchaseInvoiceItem.this.parent.getPostingDate();
				}

				@Override
				public DateTime getDeliveryDate() {
					return PurchaseInvoiceItem.this.parent.getDeliveryDate();
				}

				@Override
				public DateTime getDocumentDate() {
					return PurchaseInvoiceItem.this.parent.getDocumentDate();
				}
		...
		if (MyConfiguration.getConfigValue(MyConfiguration.CONFIG_ITEM_ENABLE_MATERIAL_PURCHASE_PRICE_RECORDING,
			...
			contracts.add(new IMaterialPriceContract() {
				...
				public BigDecimal getPrice() {
					// 转为本币
					return Decimals.multiply(PurchaseInvoiceItem.this.getPreTaxPrice(),
