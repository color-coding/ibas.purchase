...
public class ShippingAddress extends BusinessObject<ShippingAddress> implements IShippingAddress, IBOUserFields {
	 ...
	 * 顺序 属性
	 */
	@DbField(name = "Order", type = DataType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 收货人 属性
	 */
	@DbField(name = "Consignee", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 联系电话 属性
	 */
	@DbField(name = "Phone", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 电话 属性
	 */
	@DbField(name = "Telephone", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 费用 属性
	 */
	@DbField(name = "Expense", type = DataType.DECIMAL, editType = EditType.SUM, table = DB_TABLE_NAME)
	 ...
	 * 快递单号 属性
	 */
	@DbField(name = "Tracking", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 税前费用 属性
	 */
	@DbField(name = "PreTaxExpense", type = DataType.DECIMAL, editType = EditType.SUM, table = DB_TABLE_NAME)
	...
	* 来源编号 属性
	*/
	@DbField(name = "SourceKey", type = DataType.NUMERIC, table = DB_TABLE_NAME)
