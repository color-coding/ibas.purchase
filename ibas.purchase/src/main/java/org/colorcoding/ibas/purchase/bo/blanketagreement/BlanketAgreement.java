...
public class BlanketAgreement extends BusinessObject<BlanketAgreement> implements IBlanketAgreement, IDataOwnership,
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -1082872931019989045L;
	 ...
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_PH_OBKA";
	 ...
	 * 签署日期 属性
	 */
	@DbField(name = "SignDate", type = DataType.DATE, table = DB_TABLE_NAME)
	 ...
	 * 终止日期 属性
	 */
	@DbField(name = "TermDate", type = DataType.DATE, table = DB_TABLE_NAME)
	 ...
	 * 协议方法 属性
	 */
	@DbField(name = "AgrtMethod", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 协议类型 属性
	 */
	@DbField(name = "AgrtType", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 结算概率 属性
	 */
	@DbField(name = "SettPrbly", type = DataType.DECIMAL, editType = EditType.PERCENTAGE, table = DB_TABLE_NAME)
	...
	protected void initialize() {
		...
		this.setSignDate(DateTimes.today());
		this.setStartDate(DateTimes.today());
		...
		return new IBusinessLogicContract[] {
				...
				new ISupplierCheckContract() {
					...
					public String getSupplierCode() {
						return BlanketAgreement.this.getSupplierCode();
					}

					@Override
					public String getSupplierName() {
						return BlanketAgreement.this.getSupplierName();
					}

					@Override
					public void setSupplierName(String value) {
						BlanketAgreement.this.setSupplierName(value);
					}
				},
				// 分支检查
