...
* 
*/
public interface IDownPaymentRequest extends IBODocument {
    ...
    * @return 值
    */
    IDownPaymentRequestItems getDownPaymentRequestItems();
    ...
    * @param value 值
    */
    void setDownPaymentRequestItems(IDownPaymentRequestItems value);
