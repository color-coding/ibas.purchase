...
public class PurchaseOrder extends BusinessObject<PurchaseOrder>
		...
		IDocumentCloseQuantityOperator, IDocumentCloseAmountOperator, IDocumentPrintedOperator {
	...
	protected IBusinessRule[] registerRules() {
		return new IBusinessRule[] {
				...
				new BusinessRuleSumElements(PROPERTY_ITEMSLINETOTAL, PROPERTY_PURCHASEORDERITEMS,
						PurchaseOrderItem.PROPERTY_LINETOTAL, new Predicate<PurchaseOrderItem>() {
							@Override
		...
		return new IBusinessLogicContract[] {
				...
				new ISupplierAndFloorListCheckContract() {
					...
					public String getSupplierName() {
						return PurchaseOrder.this.getSupplierName();
					}

					@Override
					public void setSupplierName(String value) {
						PurchaseOrder.this.setSupplierName(value);
					}
				...
				new IBranchCheckContract() {
					...
					@Override
					public String getIdentifiers() {
						return PurchaseOrder.this.toString();
					}

					@Override
					public String getBranch() {
						return PurchaseOrder.this.getBranch();
					}
				},
				// 价格检查
