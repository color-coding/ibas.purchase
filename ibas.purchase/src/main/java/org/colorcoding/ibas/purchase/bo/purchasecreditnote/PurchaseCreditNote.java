...
public class PurchaseCreditNote extends BusinessObject<PurchaseCreditNote>
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -6632746240647100992L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PurchaseCreditNote.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_PH_ORIN";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PurchaseCreditNote";
	 ...
	 * 
	 */
	public static final IPropertyInfo<IPurchaseCreditNoteItems> PROPERTY_PURCHASECREDITNOTEITEMS = registerProperty(
			PROPERTY_PURCHASECREDITNOTEITEMS_NAME, IPurchaseCreditNoteItems.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElementWrapper(name = PROPERTY_PURCHASECREDITNOTEITEMS_NAME)
	@XmlElement(name = PurchaseCreditNoteItem.BUSINESS_OBJECT_NAME, type = PurchaseCreditNoteItem.class)
	public final IPurchaseCreditNoteItems getPurchaseCreditNoteItems() {
		return this.getProperty(PROPERTY_PURCHASECREDITNOTEITEMS);
	}
	 ...
	 * @param value 值
	 */
	public final void setPurchaseCreditNoteItems(IPurchaseCreditNoteItems value) {
		this.setProperty(PROPERTY_PURCHASECREDITNOTEITEMS, value);
	}
		...
		return new IBusinessLogicContract[] {
				...
				new ISupplierCheckContract() {
					...
					public String getIdentifiers() {
						return PurchaseCreditNote.this.getIdentifiers();
					}
				...
				new IJournalEntryCreationContract() {
					...
					public JournalEntryContent[] getContents() {
						...
						jeContent.setAmount(PurchaseCreditNote.this.getDiffAmount().negate());
	...
	public Object getValue(String property) {
		...
		case Ledgers.CONDITION_PROPERTY_MATERIAL:
			String[] items = new String[this.getPurchaseCreditNoteItems().size()];
			for (int i = 0; i < items.length; i++) {
				items[i] = this.getPurchaseCreditNoteItems().get(i).getItemCode();
			}
