...
public class PurchaseRequest extends BusinessObject<PurchaseRequest>
	...
	*/
	 ...
	 * 需求人 属性
	 */
	@DbField(name = "Requester", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 计划编号 属性
	 */
	@DbField(name = "Scheduling", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	...
	protected void initialize() {
		...
		this.setRequestDate(DateTimes.today());
