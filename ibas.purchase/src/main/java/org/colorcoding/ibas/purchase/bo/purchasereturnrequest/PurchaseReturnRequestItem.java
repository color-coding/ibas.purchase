...
@XmlType(name = PurchaseReturnRequestItem.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class PurchaseReturnRequestItem extends BusinessObject<PurchaseReturnRequestItem>
		implements IPurchaseReturnRequestItem, IBusinessLogicsHost, IBOTagDeleted, IBOTagCanceled, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -1907984920329677357L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PurchaseReturnRequestItem.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_PH_PRR1";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_PH_PURCHRETNREQ";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PurchaseReturnRequestItem";
	...
	public IBusinessLogicContract[] getContracts() {
		...
		contracts.add(new ITaxGroupCheckContract() {
			...
			public String getIdentifiers() {
				return PurchaseReturnRequestItem.this.getIdentifiers();
			}

			@Override
			public String getTax() {
				return PurchaseReturnRequestItem.this.getTax();
			}

			@Override
			public BigDecimal getTaxRate() {
				return PurchaseReturnRequestItem.this.getTaxRate();
			}
		});
		// 物料及仓库检查
		contracts.add(new IMaterialWarehouseCheckContract() {
			...
			public String getItemCode() {
				return PurchaseReturnRequestItem.this.getItemCode();
			}

			@Override
			public String getItemVersion() {
				return PurchaseReturnRequestItem.this.getItemVersion();
			}

			@Override
			public emYesNo getBatchManagement() {
				return PurchaseReturnRequestItem.this.getBatchManagement();
			}

			@Override
			public emYesNo getSerialManagement() {
				return PurchaseReturnRequestItem.this.getSerialManagement();
			}

			@Override
			public String getWarehouse() {
				return PurchaseReturnRequestItem.this.getWarehouse();
			}
		});
		// 物料目录检查
		contracts.add(new IMaterialCatalogCheckContract() {
			...
			public void setCatalogCode(String value) {
				PurchaseReturnRequestItem.this.setCatalogCode(value);
			}
			...
			public String getCatalogCode() {
				return PurchaseReturnRequestItem.this.getCatalogCode();
			}
			...
			public String getBusinessPartnerCode() {
				return PurchaseReturnRequestItem.this.parent.getSupplierCode();
			}
		});
		// 基于单据数量完成
		contracts.add(new IDocumentQuantityClosingContract() {
			...
			public BigDecimal getQuantity() {
				return PurchaseReturnRequestItem.this.getQuantity();
			}

			@Override
			public String getBaseDocumentType() {
				return PurchaseReturnRequestItem.this.getBaseDocumentType();
			}

			@Override
			public Integer getBaseDocumentEntry() {
				return PurchaseReturnRequestItem.this.getBaseDocumentEntry();
			}
