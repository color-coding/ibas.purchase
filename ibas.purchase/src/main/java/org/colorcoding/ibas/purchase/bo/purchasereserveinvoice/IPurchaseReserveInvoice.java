 ...
 * 
 */
public interface IPurchaseReserveInvoice extends IBODocument, IShippingAddressParent {
	 ...
	 * @return 值
	 */
	IPurchaseReserveInvoiceItems getPurchaseReserveInvoiceItems();
	 ...
	 * @param value 值
	 */
	void setPurchaseReserveInvoiceItems(IPurchaseReserveInvoiceItems value);
