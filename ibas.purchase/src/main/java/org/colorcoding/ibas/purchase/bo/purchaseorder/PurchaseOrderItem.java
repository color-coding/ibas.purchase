...
public class PurchaseOrderItem extends BusinessObject<PurchaseOrderItem>
		implements IPurchaseOrderItem, IBOTagDeleted, IBOTagCanceled, IBOUserFields, IBusinessLogicsHost, ICheckRules {
	...
	public IBusinessLogicContract[] getContracts() {
		...
		contracts.add(new ITaxGroupCheckContract() {
			...
			public String getTax() {
				return PurchaseOrderItem.this.getTax();
			}

			@Override
			public BigDecimal getTaxRate() {
				return PurchaseOrderItem.this.getTaxRate();
			}
		});
		// 物料及仓库检查
		contracts.add(new IMaterialWarehouseCheckContract() {
			...
			public emYesNo getBatchManagement() {
				return PurchaseOrderItem.this.getBatchManagement();
			}

			@Override
			public emYesNo getSerialManagement() {
				return PurchaseOrderItem.this.getSerialManagement();
			}
		...
		contracts.add(new IMaterialCatalogCheckContract() {
			...
			public void setCatalogCode(String value) {
				PurchaseOrderItem.this.setCatalogCode(value);
			}
			...
			public String getCatalogCode() {
				return PurchaseOrderItem.this.getCatalogCode();
			}
			...
			public String getBusinessPartnerCode() {
				return PurchaseOrderItem.this.parent.getSupplierCode();
			}
		});
		// 物料已订购数量
		contracts.add(new IMaterialOrderedJournalContract() {
			...
			public BigDecimal getQuantity() {
				return Decimals.multiply(PurchaseOrderItem.this.getQuantity(), PurchaseOrderItem.this.getUOMRate());
			}

			@Override
			public BigDecimal getClosedQuantity() {
				return Decimals.multiply(PurchaseOrderItem.this.getClosedQuantity(),
		...
		if (MyConfiguration.applyVariables(SalesOrder.BUSINESS_OBJECT_CODE)
			...
			contracts.add(new IDocumentQuantityClosingContract() {
				...
				public IMaterialBatchItems getMaterialBatches() {
					return PurchaseOrderItem.this.getMaterialBatches();
				}

				@Override
				public IMaterialSerialItems getMaterialSerials() {
					return PurchaseOrderItem.this.getMaterialSerials();
				}
