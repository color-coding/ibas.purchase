...
@XmlType(name = PurchaseReserveInvoiceItem.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class PurchaseReserveInvoiceItem extends BusinessObject<PurchaseReserveInvoiceItem>
		implements IPurchaseReserveInvoiceItem, IBusinessLogicsHost, IBOTagDeleted, IBOTagCanceled, IBOUserFields,
		IJECPropertyValueGetter {
	 ...
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PurchaseReserveInvoiceItem.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_PH_RIV1";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_PH_PURCHRSVINVOICE";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PurchaseReserveInvoiceItem";
		...
		return new IBusinessLogicContract[] {
				...
				new ITaxGroupCheckContract() {
					...
					public String getTax() {
						return PurchaseReserveInvoiceItem.this.getTax();
					}

					@Override
					public BigDecimal getTaxRate() {
						return PurchaseReserveInvoiceItem.this.getTaxRate();
					}
				},
				// 物料及仓库检查
				new IMaterialWarehouseCheckContract() {
					...
					public String getItemVersion() {
						return PurchaseReserveInvoiceItem.this.getItemVersion();
					}

					@Override
					public emYesNo getBatchManagement() {
						return PurchaseReserveInvoiceItem.this.getBatchManagement();
					}

					@Override
					public emYesNo getSerialManagement() {
						return PurchaseReserveInvoiceItem.this.getSerialManagement();
					}
				...
				new IBlanketAgreementQuantityContract() {
					...
					public BigDecimal getAmount() {
						// 一揽子协议金额按不含税口径
						return PurchaseReserveInvoiceItem.this.getPreTaxLineTotal();
					}

					@Override
					public String getBaseDocumentType() {
						return PurchaseReserveInvoiceItem.this.getBaseDocumentType();
					}

					@Override
					public Integer getBaseDocumentEntry() {
						return PurchaseReserveInvoiceItem.this.getBaseDocumentEntry();
					}

					@Override
					public Integer getBaseDocumentLineId() {
						return PurchaseReserveInvoiceItem.this.getBaseDocumentLineId();
					}
