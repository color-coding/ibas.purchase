		...
		return new IBusinessLogicContract[] {
				...
				new ISupplierCheckContract() {
					...
					public String getSupplierName() {
						return PurchaseReturn.this.getSupplierName();
					}

					@Override
					public void setSupplierName(String value) {
						PurchaseReturn.this.setSupplierName(value);
					}
				},
				// 分支检查
						...
						if (!Decimals.VALUE_ONE.equals(PurchaseReturn.this.getDiscount())) {
							for (JournalEntryContent item : jeContents) {
								...
								if (Ledgers.LEDGER_INVENTORY_INVENTORY_ACCOUNT.equals(item.getLedger())
									...
									item.setAmount(Decimals.multiply(item.getAmount(), PurchaseReturn.this.getDiscount()));
								}
							}
						}
						// 送货地址-运费
