...
public class PurchaseReturnRequest extends BusinessObject<PurchaseReturnRequest> implements IPurchaseReturnRequest,
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 6696632421509931564L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PurchaseReturnRequest.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_PH_OPRR";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "PurchaseReturnRequest";
	 ...
	 * 折扣后总计 属性
	 */
	@DbField(name = "DiscSum", type = DataType.DECIMAL, editType = EditType.SUM, table = DB_TABLE_NAME)
	 ...
	 * 已付款总计 属性
	 */
	@DbField(name = "PaidTotal", type = DataType.DECIMAL, editType = EditType.SUM, table = DB_TABLE_NAME)
	 ...
	 * 价格清单 属性
	 */
	@DbField(name = "PriceList", type = DataType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 付款条款代码 属性
	 */
	@DbField(name = "PaymentCode", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 舍入 属性
	 */
	@DbField(name = "Rounding", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 舍入差额 属性
	 */
	@DbField(name = "RoundDiff", type = DataType.DECIMAL, editType = EditType.SUM, table = DB_TABLE_NAME)
	 ...
	 * 属性名称-采购退货请求-行
	 */
	private static final String PROPERTY_PURCHASERETURNREQUESTITEMS_NAME = "PurchaseReturnRequestItems";

	/**
	 * 采购退货请求-行的集合属性
	 * 
	 */
	public static final IPropertyInfo<IPurchaseReturnRequestItems> PROPERTY_PURCHASERETURNREQUESTITEMS = registerProperty(
			PROPERTY_PURCHASERETURNREQUESTITEMS_NAME, IPurchaseReturnRequestItems.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElementWrapper(name = PROPERTY_PURCHASERETURNREQUESTITEMS_NAME)
	@XmlElement(name = PurchaseReturnRequestItem.BUSINESS_OBJECT_NAME, type = PurchaseReturnRequestItem.class)
	public final IPurchaseReturnRequestItems getPurchaseReturnRequestItems() {
		return this.getProperty(PROPERTY_PURCHASERETURNREQUESTITEMS);
	}
	 ...
	 * @param value 值
	 */
	public final void setPurchaseReturnRequestItems(IPurchaseReturnRequestItems value) {
		this.setProperty(PROPERTY_PURCHASERETURNREQUESTITEMS, value);
	}
	...
	protected void initialize() {
		...
		this.setPurchaseReturnRequestItems(new PurchaseReturnRequestItems(this));
	...
	protected IBusinessRule[] registerRules() {
		return new IBusinessRule[] {
				...
				// 计算行-总计（含税）
				new BusinessRuleSumElements(PROPERTY_ITEMSLINETOTAL, PROPERTY_PURCHASERETURNREQUESTITEMS,
						PurchaseReturnRequestItem.PROPERTY_LINETOTAL, new Predicate<PurchaseReturnRequestItem>() {
							@Override
							public boolean test(PurchaseReturnRequestItem t) {
								// 过滤，标记删除
	...
	protected void reset() {
		...
		this.setDocumentStatus(emDocumentStatus.RELEASED);
		this.getPurchaseReturnRequestItems().forEach(c -> c.setLineStatus(emDocumentStatus.RELEASED));
	}
		...
		return new IBusinessLogicContract[] {
				...
				new ISupplierCheckContract() {
					...
					public String getIdentifiers() {
						return PurchaseReturnRequest.this.getIdentifiers();
					}
				...
				new IBranchCheckContract() {
					...
					@Override
					public String getIdentifiers() {
						return PurchaseReturnRequest.this.toString();
					}

					@Override
					public String getBranch() {
						return PurchaseReturnRequest.this.getBranch();
					}
				}
	...
	public Iterator<IDocumentClosingQuantityItem> getQuantityItems() {
		return new Iterator<IDocumentClosingQuantityItem>() {
			...
			public IDocumentClosingQuantityItem next() {
				this.index += 1;
				return PurchaseReturnRequest.this.getPurchaseReturnRequestItems().get(this.index);
			}

			@Override
			public boolean hasNext() {
				if (PurchaseReturnRequest.this.getPurchaseReturnRequestItems().isEmpty()) {
					return false;
				}
				int nIndex = this.index + 1;
				if (nIndex >= PurchaseReturnRequest.this.getPurchaseReturnRequestItems().size()) {
					return false;
				}
				return true;
			}
