...
namespace purchase {
    export namespace app {
        ...
        export class PurchaseRequestEditApp extends ibas.BOEditService<IPurchaseRequestEditView, bo.PurchaseRequest> {
            ...
            /** 添加采购申请-行事件 */
            private addPurchaseRequestItem(items: bo.PurchaseRequestItem[] | number): void {
            ...
            /** 更改行价格 */
            private changePurchaseRequestItemPrice(priceList: number | ibas.ICriteria, items?: bo.PurchaseRequestItem[]): void {
            ...
            protected viewHistoricalPrices(caller: bo.PurchaseRequestItem): void {
                ...
                if (ibas.strings.isEmpty(caller.supplier)) {
                    this.messages(
