...
namespace purchase {
    export namespace app {
        ...
        export class PurchaseDeliveryEditApp extends ibas.BOEditService<IPurchaseDeliveryEditView, bo.PurchaseDelivery> {
            ...
            /** 更改行价格 */
            private changePurchaseDeliveryItemPrice(priceList: number | ibas.Criteria, items?: bo.PurchaseDeliveryItem[]): void {
            ...
            private choosePurchaseDeliveryItemUnit(caller: bo.PurchaseDeliveryItem): void {
                let that: this = this;
