...
namespace purchase {
    export namespace app {
        ...
        export class PurchaseOrderEditApp extends ibas.BOEditService<IPurchaseOrderEditView, bo.PurchaseOrder> {
            ...
            /** 更改行价格 */
            private changePurchaseOrderItemPrice(priceList: number | ibas.Criteria, items?: bo.PurchaseOrderItem[]): void {
            ...
            private choosePurchaseOrderItemUnit(caller: bo.PurchaseOrderItem, criteria?: ibas.ICriteria): void {
