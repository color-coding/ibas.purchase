...
namespace purchase {
    export namespace app {
        /** 列表应用-采购发票 */
        export class PurchaseInvoiceListApp extends ibas.BOListApplication<IPurchaseInvoiceListView, bo.PurchaseInvoice> {

            /** 应用标识 */
            static APPLICATION_ID: string = "d11cb566-9079-4881-afc1-f81721b23beb";
            /** 应用名称 */
            static APPLICATION_NAME: string = "purchase_app_purchaseinvoice_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.PurchaseInvoice.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = PurchaseInvoiceListApp.APPLICATION_ID;
                this.name = PurchaseInvoiceListApp.APPLICATION_NAME;
                this.boCode = PurchaseInvoiceListApp.BUSINESS_OBJECT_CODE;
            ...
            protected viewData(data: bo.PurchaseInvoice): void {
                ...
                let app: PurchaseInvoiceViewApp = new PurchaseInvoiceViewApp();
                app.navigation = this.navigation;
                app.viewShower = this.viewShower;
                app.run(data);
            ...
            protected deleteData(data: bo.PurchaseInvoice | bo.PurchaseInvoice[]): void {
                let beDeleteds: ibas.IList<bo.PurchaseInvoice> = ibas.arrays.create(data);
                // 没有选择删除的对象
        ...
        /** 视图-采购发票 */
        export interface IPurchaseInvoiceListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */
