...
namespace purchase {
    export namespace app {
        ...
        export class PurchaseCreditNoteEditApp extends ibas.BOEditService<IPurchaseCreditNoteEditView, bo.PurchaseCreditNote> {
            ...
            /** 更改行价格 */
            private changePurchaseCreditNoteItemPrice(priceList: number | ibas.ICriteria, items?: bo.PurchaseCreditNoteItem[]): void {
            ...
            protected calculateQuantity(caller: bo.PurchaseCreditNoteItem): void {
                if (ibas.objects.isNull(caller)) {
                    this.messages(ibas.emMessageType.WARNING, ibas.i18n.prop("shell_please_chooose_data",
                        ibas.i18n.prop("shell_data_view")
                    )); return;
