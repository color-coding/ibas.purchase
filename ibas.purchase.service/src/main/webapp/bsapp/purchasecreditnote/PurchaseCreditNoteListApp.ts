...
namespace purchase {
    export namespace app {
        /** 列表应用-采购贷项 */
        export class PurchaseCreditNoteListApp extends ibas.BOListApplication<IPurchaseCreditNoteListView, bo.PurchaseCreditNote> {

            /** 应用标识 */
            static APPLICATION_ID: string = "8895e84e-c3ea-4a05-9633-dc5640b989b0";
            /** 应用名称 */
            static APPLICATION_NAME: string = "purchase_app_purchasecreditnote_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.PurchaseCreditNote.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = PurchaseCreditNoteListApp.APPLICATION_ID;
                this.name = PurchaseCreditNoteListApp.APPLICATION_NAME;
                this.boCode = PurchaseCreditNoteListApp.BUSINESS_OBJECT_CODE;
            ...
            protected viewData(data: bo.PurchaseCreditNote): void {
                ...
                let app: PurchaseCreditNoteViewApp = new PurchaseCreditNoteViewApp();
                app.navigation = this.navigation;
                app.viewShower = this.viewShower;
                app.run(data);
            ...
            protected deleteData(data: bo.PurchaseCreditNote | bo.PurchaseCreditNote[]): void {
                let beDeleteds: ibas.IList<bo.PurchaseCreditNote> = ibas.arrays.create(data);
                // 没有选择删除的对象
        ...
        /** 视图-采购贷项 */
        export interface IPurchaseCreditNoteListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */
