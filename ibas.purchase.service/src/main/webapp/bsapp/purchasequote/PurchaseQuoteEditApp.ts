...
namespace purchase {
    export namespace app {
        ...
        export class PurchaseQuoteEditApp extends ibas.BOEditService<IPurchaseQuoteEditView, bo.PurchaseQuote> {
            ...
            /** 更改行价格 */
            private changePurchaseQuoteItemPrice(priceList: number | ibas.Criteria, items?: bo.PurchaseQuoteItem[]): void {
            ...
            private choosePurchaseQuoteItemUnit(caller: bo.PurchaseQuoteItem): void {
                let that: this = this;
