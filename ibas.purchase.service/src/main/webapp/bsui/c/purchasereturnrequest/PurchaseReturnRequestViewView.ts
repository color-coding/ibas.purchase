...
namespace purchase {
    export namespace ui {
        export namespace c {
            /** 查看视图-采购退货请求 */
            export class PurchaseReturnRequestViewView extends ibas.BOViewView implements app.IPurchaseReturnRequestViewView {

                /** 绘制视图 */
                draw(): any {
                    let that: this = this;
                    this.tablePurchaseReturnRequestItem = new sap.extension.m.DataTable("", {
                        autoPopinMode: true,
                        dataInfo: {
                        ...
                        columns: [
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereturnrequestitem_lineid"),
                                width: "5rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereturnrequestitem_itemdescription"),
                                width: "20rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereturnrequestitem_quantity"),
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereturnrequestitem_warehouse"),
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereturnrequestitem_price"),
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereturnrequestitem_linetotal"),
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereturnrequestitem_reference1"),
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereturnrequestitem_reference2"),
                            }),
                        ],
                        items: {
                            path: "/rows",
                    ...
                    return this.page = new sap.extension.uxap.DataObjectPageLayout("", {
                        ...
                        headerTitle: new sap.uxap.ObjectPageHeader("", {
                            ...
                            actions: [
                                ...
                                new sap.extension.m.ObjectYesNoStatus("", {
                                    title: ibas.i18n.prop("bo_purchasereturnrequest_canceled"),
                                    negative: true,
                                    enumValue: {
                                        path: "canceled",
                        ...
                        headerContent: [
                            new sap.ui.layout.VerticalLayout("", {
                                ...
                                content: [
                                    new sap.extension.m.RepositoryObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchasereturnrequest_contactperson"),
                                        bindingValue: {
                                            path: "contactPerson",
                                            type: new sap.extension.data.Alphanumeric(),
                                        },
                                    ...
                                    new sap.extension.m.RepositoryObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchasereturnrequest_pricelist"),
                                        bindingValue: {
                                            path: "priceList",
                                            type: new sap.extension.data.Alphanumeric(),
                                        },
                            ...
                            new sap.ui.layout.VerticalLayout("", {
                                ...
                                content: [
                                    /*
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchasereturnrequest_postingdate"),
                                        bindingValue: {
                                            path: "postingDate",
                                    ...
                                    */
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchasereturnrequest_agreements"),
                                        bindingValue: {
                                            path: "agreements",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                            ...
                            new sap.ui.layout.VerticalLayout("", {
                                ...
                                content: [
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchasereturnrequest_documenttaxtotal"),
                                        bindingValue: {
                                            parts: [
                                                {
                                                    path: "itemsTaxTotal",
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchasereturnrequest_shippingsexpensetotal"),
                                        bindingValue: {
                                            parts: [
                                                {
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchasereturnrequest_paidtotal"),
                                        bindingValue: {
                                            parts: [
                                                {
                                                    path: "paidTotal",
                            ...
                            new sap.uxap.ObjectPageSection("", {
                                ...
                                subSections: [
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            this.tablePurchaseReturnRequestItem
                                        ],
                                    })
                                ]
                            }),
                                    ...
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            new sap.ui.layout.VerticalLayout("", {
                                                content: [
                                                    new sap.extension.m.ObjectAttribute("", {
                                                        title: ibas.i18n.prop("bo_purchasereturnrequest_remarks"),
                                                        bindingValue: {
                                                            path: "remarks",
                                                            type: new sap.extension.data.Alphanumeric(),
                                                        }
                                            ...
                                            new sap.ui.layout.VerticalLayout("", {
                                                content: [
                                                    new sap.extension.m.UserObjectAttribute("", {
                                                        title: ibas.i18n.prop("bo_purchasereturnrequest_dataowner"),
                                                        bindingValue: {
                                                            path: "dataOwner",
                                                            type: new sap.extension.data.Alphanumeric(),
                                                        }
                                                    ...
                                                    new sap.extension.m.RepositoryObjectAttribute("", {
                                                        title: ibas.i18n.prop("bo_purchasereturnrequest_project"),
                                                        bindingValue: {
                                                            path: "project",
                                                            type: new sap.extension.data.Alphanumeric(),
                                                        },
                                                    ...
                                                    new sap.extension.m.OrganizationObjectAttribute("", {
                                                        title: ibas.i18n.prop("bo_purchasereturnrequest_organization"),
                                                        bindingValue: {
                                                            path: "organization",
                                                            type: new sap.extension.data.Alphanumeric(),
                                                        }
                ...
                private tablePurchaseReturnRequestItem: sap.extension.m.Table;
