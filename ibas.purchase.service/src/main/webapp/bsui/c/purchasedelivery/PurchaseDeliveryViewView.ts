                    ...
                    return this.page = new sap.extension.uxap.DataObjectPageLayout("", {
                        ...
                        headerContent: [
                            new sap.ui.layout.VerticalLayout("", {
                                ...
                                content: [
                                    new sap.extension.m.RepositoryObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchasedelivery_contactperson"),
                                        bindingValue: {
                                            path: "contactPerson",
                                            type: new sap.extension.data.Alphanumeric(),
                                        },
                            ...
                            new sap.ui.layout.VerticalLayout("", {
                                ...
                                content: [
                                    ...
                                    */
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchasedelivery_agreements"),
                                        bindingValue: {
                                            path: "agreements",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                            ...
                            new sap.ui.layout.VerticalLayout("", {
                                ...
                                content: [
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchasedelivery_documenttaxtotal"),
                                        bindingValue: {
                                            parts: [
                                                {
                                                    path: "itemsTaxTotal",
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchasedelivery_shippingsexpensetotal"),
                                        bindingValue: {
                                            parts: [
                                                {
