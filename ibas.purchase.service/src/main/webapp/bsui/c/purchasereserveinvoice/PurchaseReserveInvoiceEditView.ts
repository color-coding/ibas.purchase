...
namespace purchase {
    export namespace ui {
        export namespace c {
             ...
             * 编辑视图-采购预留发票
             */
            export class PurchaseReserveInvoiceEditView extends ibas.BOEditView implements app.IPurchaseReserveInvoiceEditView {
                /** 删除数据事件 */
                ...
                draw(): any {
                    ...
                    let formTop: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        ...
                        content: [
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_suppliercode") }),
                            new sap.extension.m.RepositoryInput("", {
                                showValueHelp: true,
                                valueHelpRequest: function (): void {
                                    that.fireViewEvents(that.choosePurchaseReserveInvoiceSupplierEvent);
                                },
                                showValueLink: true,
                                ...
                                suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                    ...
                                    if (!ibas.objects.isNull(selectedItem)) {
                                        that.fireViewEvents(that.choosePurchaseReserveInvoiceSupplierEvent, this.itemConditions(selectedItem));
                                    }
                                },
                                editable: {
                                    parts: [
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_suppliername") }),
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_contactperson") }),
                            new sap.extension.m.RepositoryInput("", {
                                showValueHelp: true,
                                repository: businesspartner.bo.BORepositoryBusinessPartner,
                                dataInfo: {
                                ...
                                valueHelpRequest: function (): void {
                                    that.fireViewEvents(that.choosePurchaseReserveInvoiceContactPersonEvent);
                                },
                            }).bindProperty("bindingValue", {
                                path: "contactPerson",
                                type: new sap.extension.data.Numeric()
                            }),
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_pricelist") }),
                            new sap.m.FlexBox("", {
                                width: "100%",
                                ...
                                items: [
                                    new sap.extension.m.RepositoryInput("", {
                                        ...
                                        valueHelpRequest: function (): void {
                                            that.fireViewEvents(that.choosePurchaseReserveInvoicePriceListEvent);
                                        },
                                    }).bindProperty("bindingValue", {
                                        path: "priceList",
                                        type: new sap.extension.data.Numeric()
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_ordertype") }),
                            new sap.extension.m.PropertySelect("", {
                                dataInfo: {
                                    code: bo.PurchaseReserveInvoice.BUSINESS_OBJECT_CODE,
                                },
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_reference1") }),
                            new sap.extension.m.Input("", {
                            }).bindProperty("bindingValue", {
                                path: "reference1",
                                type: new sap.extension.data.Alphanumeric({
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_reference2") }),
                            new sap.extension.m.Input("", {
                            }).bindProperty("bindingValue", {
                                path: "reference2",
                                type: new sap.extension.data.Alphanumeric({
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_docentry") }),
                            new sap.extension.m.Input("", {
                                editable: false,
                            }).bindProperty("bindingValue", {
                                path: "docEntry",
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_docnum") }),
                            new sap.extension.m.Input("", {
                            }).bindProperty("bindingValue", {
                                path: "docNum",
                                type: new sap.extension.data.Alphanumeric({
                            ...
                            new sap.extension.m.SeriesSelect("", {
                                objectCode: bo.BO_CODE_PURCHASERESERVEINVOICE,
                            }).bindProperty("bindingValue", {
                                path: "series",
                                type: new sap.extension.data.Numeric()
                            }).bindProperty("editable", {
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_documentstatus") }),
                            new sap.m.FlexBox("", {
                                width: "100%",
                                justifyContent: sap.m.FlexJustifyContent.Start,
                                renderType: sap.m.FlexRendertype.Bare,
                                ...
                                items: [
                                    ...
                                    new sap.extension.m.TipsCheckBox("", {
                                        text: ibas.i18n.prop("bo_purchasereserveinvoice_canceled"),
                                    ...
                                    new sap.extension.m.CheckBox("", {
                                        text: ibas.i18n.prop("bo_purchasereserveinvoice_printed"),
                                        editable: false,
                                    }).bindProperty("bindingValue", {
                                        path: "printed",
                                        type: new sap.extension.data.YesNo()
                            ...
                            new sap.m.Label("", {
                                text: ibas.i18n.prop("bo_purchasereserveinvoice_cancellationdate"),
                                visible: {
                                    path: "canceled",
                                    formatter(data: any): any {
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_documentdate") }),
                            new sap.extension.m.DatePicker("", {
                                change(event: sap.ui.base.Event): void {
                                    ...
                                    if (source instanceof sap.m.DatePicker) {
                                        ...
                                        if (data instanceof bo.PurchaseReserveInvoice && !ibas.strings.isEmpty(data.paymentCode)) {
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_deliverydate") }),
                            new sap.extension.m.DatePicker("", {
                            }).bindProperty("bindingValue", {
                                path: "deliveryDate",
                                type: new sap.extension.data.Date()
                    ...
                    let formPurchaseReserveInvoiceItem: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        editable: true,
                        content: [
                            new sap.ui.core.Title("", { text: ibas.i18n.prop("bo_purchasereserveinvoiceitem") }),
                            this.tablePurchaseReserveInvoiceItem = new sap.extension.table.DataTable("", {
                                enableSelectAll: false,
                                visibleRowCount: sap.extension.table.visibleRowCount(8),
                                dataInfo: {
                                    code: bo.PurchaseReserveInvoice.BUSINESS_OBJECT_CODE,
                                    name: bo.PurchaseReserveInvoiceItem.name
                                },
                                toolbar: new sap.m.Toolbar("", {
                                    content: [
                                        new sap.m.MenuButton("", {
                                            ...
                                            menu: new sap.m.Menu("", {
                                                items: [
                                                    ...
                                                    new sap.m.MenuItem("", {
                                                        ...
                                                        press: function (): void {
                                                            that.fireViewEvents(that.addPurchaseReserveInvoiceItemEvent, that.tablePurchaseReserveInvoiceItem.getSelecteds());
                                                        }
                                                    }),
                                                    new sap.m.MenuItem("", {
                                                        text: ibas.i18n.prop("bo_purchaseorder"),
                                                        press: function (): void {
                                                            that.fireViewEvents(that.choosePurchaseReserveInvoicePurchaseOrderEvent);
                                                        },
                                            ...
                                            defaultAction(): void {
                                                that.fireViewEvents(that.addPurchaseReserveInvoiceItemEvent, 1);
                                            }
                                        }),
                                        new sap.m.Button("", {
                                            ...
                                            icon: "sap-icon://less",
                                            press: function (): void {
                                                that.fireViewEvents(that.removePurchaseReserveInvoiceItemEvent, that.tablePurchaseReserveInvoiceItem.getSelecteds());
                                            }
                                        }),
                                            ...
                                            menu: new sap.m.Menu("", {
                                                items: [
                                                    new sap.m.MenuItem("", {
                                                        ...
                                                        press: function (): void {
                                                            that.fireViewEvents(that.choosePurchaseReserveInvoiceItemMaterialBatchEvent);
                                                        },
                                                        visible: shell.app.privileges.canRun({
                                                    ...
                                                    new sap.m.MenuItem("", {
                                                        ...
                                                        press: function (): void {
                                                            that.fireViewEvents(that.choosePurchaseReserveInvoiceItemMaterialSerialEvent);
                                                        },
                                                        visible: shell.app.privileges.canRun({
                                        ...
                                        this.selectWarehouse = new component.WarehouseSelect("", {
                                            ...
                                            change(this: sap.m.Select, event: sap.ui.base.Event): void {
                                                ...
                                                if (sItem instanceof sap.ui.core.Item && !ibas.strings.isEmpty(sItem.getKey())) {
                                                    let model: any = that.tablePurchaseReserveInvoiceItem.getModel();
                                                    if (model instanceof sap.extension.model.JSONModel) {
                                                        let data: any[] = model.getData("rows");
                                                        if (data instanceof Array) {
                                                            let items: ibas.IList<bo.PurchaseReserveInvoiceItem> = new ibas.ArrayList<bo.PurchaseReserveInvoiceItem>();
                                                            for (let item of data) {
                                                                if (item instanceof bo.PurchaseReserveInvoiceItem) {
                                ...
                                columns: [
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_lineid"),
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_linestatus"),
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_catalogcode"),
                                        template: new sap.extension.m.RepositoryInput("", {
                                            showValueHelp: true,
                                            valueHelpRequest: function (): void {
                                                that.fireViewEvents(that.choosePurchaseReserveInvoiceItemMaterialCatalogEvent,
                                                    // 获取当前对象
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                let selectedItem: any = event.getParameter("selectedItem");
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.choosePurchaseReserveInvoiceItemMaterialCatalogEvent, this.getBindingContext().getObject(), this.itemConditions(selectedItem));
                                                }
                                            },
                                                ...
                                                if (typeof data === "string") {
                                                    if (data?.indexOf("\n") > 0) {
                                                        sap.extension.tables.fillingCellsData(source, data,
                                                            (rowCount) => {
                                                                that.fireViewEvents(that.addPurchaseReserveInvoiceItemEvent, rowCount);
                                                                return true;
                                                            },
                                                            (cell, value) => {
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_itemcode"),
                                        template: new sap.extension.m.RepositoryInput("", {
                                            showValueHelp: true,
                                            valueHelpRequest: function (): void {
                                                that.fireViewEvents(that.choosePurchaseReserveInvoiceItemMaterialEvent,
                                                    // 获取当前对象
                                                    this.getBindingContext().getObject()
                                                );
                                            },
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                let selectedItem: any = event.getParameter("selectedItem");
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.choosePurchaseReserveInvoiceItemMaterialEvent, this.getBindingContext().getObject(), this.itemConditions(selectedItem));
                                                }
                                            },
                                            criteria: [
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        ...
                                        template: new sap.extension.m.RepositoryInput("", {
                                            ...
                                            valueHelpRequest: function (): void {
                                                that.fireViewEvents(that.choosePurchaseReserveInvoiceItemWarehouseEvent,
                                                    // 获取当前对象
                                                    this.getBindingContext().getObject()
                                                );
                                            },
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                let selectedItem: any = event.getParameter("selectedItem");
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.choosePurchaseReserveInvoiceItemWarehouseEvent, this.getBindingContext().getObject(), this.itemConditions(selectedItem));
                                                }
                                            },
                                            criteria: [
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_quantity"),
                                        template: new sap.extension.m.Input("", {
                                        }).bindProperty("bindingValue", {
                                            path: "quantity",
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_uom"),
                                        template: new sap.extension.m.RepositoryInput("", {
                                            showValueHelp: true,
                                            valueHelpRequest: function (): void {
                                                that.fireViewEvents(that.choosePurchaseReserveInvoiceItemUnitEvent,
                                                    // 获取当前对象
                                                    this.getBindingContext().getObject()
                                                );
                                            },
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                let selectedItem: any = event.getParameter("selectedItem");
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.choosePurchaseReserveInvoiceItemUnitEvent, this.getBindingContext().getObject(), this.itemConditions(selectedItem));
                                                }
                                            },
                                            criteria: [
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_price"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpOnly: false,
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_linetotal"),
                                        template: new sap.extension.m.Input("", {
                                            fieldWidth: "70%",
                                        }).bindProperty("bindingValue", {
                                            path: "lineTotal",
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_tax"),
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_pretaxprice"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpOnly: false,
                                            valueHelpIconSrc: "sap-icon://time-overtime",
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_unitprice"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpOnly: false,
                                            valueHelpIconSrc: "sap-icon://time-overtime",
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_reference1"),
                                        template: new sap.extension.m.Input("", {
                                        }).bindProperty("bindingValue", {
                                            path: "reference1",
                                            type: new sap.extension.data.Alphanumeric({
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_reference2"),
                                        template: new sap.extension.m.Input("", {
                                        }).bindProperty("bindingValue", {
                                            path: "reference2",
                                            type: new sap.extension.data.Alphanumeric({
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_distributionrule1"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.choosePurchaseReserveInvoiceItemDistributionRuleEvent,
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_distributionrule2"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.choosePurchaseReserveInvoiceItemDistributionRuleEvent,
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_distributionrule3"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.choosePurchaseReserveInvoiceItemDistributionRuleEvent,
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_distributionrule4"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.choosePurchaseReserveInvoiceItemDistributionRuleEvent,
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereserveinvoiceitem_distributionrule5"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.choosePurchaseReserveInvoiceItemDistributionRuleEvent,
                    ...
                    let formBottom: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        ...
                        content: [
                            ...
                            new sap.m.Label("", {
                                text: ibas.i18n.prop("bo_purchasereserveinvoice_branch"),
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_dataowner") }),
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_project") }),
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_organization") }),
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_remarks") }),
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_documentlinetotal") }),
                            new sap.extension.m.Input("", {
                                editable: false,
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_documentlinediscount") }),
                            new sap.extension.m.Input("", {
                                editable: true,
                            }).bindProperty("bindingValue", {
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_shippingsexpensetotal") }),
                            new sap.extension.m.Input("", {
                                editable: false,
                            }).bindProperty("bindingValue", {
                                parts: [
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_documenttaxtotal") }),
                            new sap.extension.m.Input("", {
                                editable: false,
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_rounding") }),
                            new sap.m.FlexBox("", {
                                width: "100%",
                                justifyContent: sap.m.FlexJustifyContent.Start,
                                renderType: sap.m.FlexRendertype.Bare,
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_documenttotal") }),
                            new sap.m.FlexBox("", {
                                width: "100%",
                                justifyContent: sap.m.FlexJustifyContent.Start,
                                renderType: sap.m.FlexRendertype.Bare,
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereserveinvoice_paidtotal") }),
                            new sap.extension.m.Input("", {
                                editable: false,
                    ...
                    return this.page = new sap.extension.m.DataPage("", {
                                    ...
                                    menu: new sap.m.Menu("", {
                                        items: [
                                            new sap.m.MenuItem("", {
                                                ...
                                                press: function (): void {
                                                    let data: any = this.getBindingContext().getObject();
                                                    if (data instanceof bo.PurchaseReserveInvoice) {
                                                        let criteria: ibas.ICriteria = new ibas.Criteria();
                                                        criteria.result = 1;
                                                        let condition: ibas.ICondition = criteria.conditions.create();
                        ...
                        content: [
                            formTop,
                            formPurchaseReserveInvoiceItem,
                            formBottom,
                        ]
                    });
                }
                ...
                private tablePurchaseReserveInvoiceItem: sap.extension.table.Table;
                ...
                showPurchaseReserveInvoiceItems(datas: bo.PurchaseReserveInvoiceItem[]): void {
                    this.tablePurchaseReserveInvoiceItem.setModel(new sap.extension.model.JSONModel({ rows: datas }));
                }
            }
        }
    }
