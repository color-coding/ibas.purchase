                ...
                draw(): any {
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_purchasereserveinvoice_documentcurrency"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                    ...
                    this.itemTable = new sap.extension.m.DataTable("", {
                        ...
                        columns: [
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereserveinvoiceitem_lineid"),
                                width: "6rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereserveinvoiceitem_itemcode"),
                                width: "10rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereserveinvoiceitem_itemdescription"),
                                width: "14rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereserveinvoiceitem_warehouse"),
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereserveinvoiceitem_quantity"),
                                width: "8rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereserveinvoiceitem_price"),
                                width: "8rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereserveinvoiceitem_linetotal"),
                                width: "8rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereserveinvoiceitem_reference1"),
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_purchasereserveinvoiceitem_reference2"),
                            }),
                        ],
                        items: {
                            path: "/",
                                        ...
                                        footer: new sap.m.Toolbar("", {
                                            content: [
                                                ...
                                                new sap.m.Button("", {
                                                    ...
                                                    type: sap.m.ButtonType.Default,
                                                    press: function (): void {
                                                        let selectItems: bo.PurchaseReserveInvoiceItem[] = that.itemTable.getSelecteds();
                                                        if (selectItems.length > 0) {
                                                            let selects: bo.PurchaseReserveInvoice[] = that.table.getSelecteds();
