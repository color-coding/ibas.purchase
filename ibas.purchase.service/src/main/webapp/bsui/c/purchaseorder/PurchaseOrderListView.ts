                ...
                draw(): any {
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_purchaseorder_printed"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "printed",
                                    type: new sap.extension.data.YesNo(true)
                            ...
                            content: [
                                    ...
                                    menu: new sap.m.Menu("", {
                                        items: [
                                            ...
                                            new sap.m.MenuItem("", {
                                                ...
                                                press: function (): void {
                                                    that.fireViewEvents(that.reserveMaterialsOrderedEvent, that.table.getSelecteds());
                                                },
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (event: sap.ui.base.Event): void {
                                        ...
                                        for (let item of that.table.getSelecteds<bo.PurchaseOrder>()) {
                                            criteria.result++;
