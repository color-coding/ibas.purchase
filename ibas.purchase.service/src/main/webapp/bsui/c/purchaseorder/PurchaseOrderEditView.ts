                ...
                draw(): any {
                    ...
                    let formTop: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        ...
                        content: [
                            ...
                            new sap.m.FlexBox("", {
                                ...
                                items: [
                                    ...
                                    new sap.extension.m.CheckBox("", {
                                        text: ibas.i18n.prop("bo_purchaseorder_printed"),
                                        editable: false,
                                    }).bindProperty("bindingValue", {
                                        path: "printed",
                                        type: new sap.extension.data.YesNo()
                            ...
                            new sap.m.Label("", {
                                visible: false,
                                text: ibas.i18n.prop("bo_purchaseorder_postingdate"),
                            }),
                            new sap.extension.m.DatePicker("", {
                                visible: false,
                            }).bindProperty("bindingValue", {
                            ...
                            new sap.m.Label("", {
                                visible: false,
                                text: ibas.i18n.prop("bo_purchaseorder_consumer")
                            }),
                            new sap.extension.m.Input("", {
                                visible: false,
                            }).bindProperty("bindingValue", {
                        ...
                        content: [
                            ...
                            this.tablePurchaseOrderItem = new sap.extension.table.DataTable("", {
                                ...
                                toolbar: new sap.m.Toolbar("", {
                                    content: [
                                        new sap.m.MenuButton("", {
                                            ...
                                            defaultAction(): void {
                                                that.fireViewEvents(that.addPurchaseOrderItemEvent, 1);
                                            }
                                        }),
                                        new sap.m.Button("", {
                                ...
                                columns: [
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        ...
                                        template: new sap.extension.m.RepositoryInput("", {
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                let selectedItem: any = event.getParameter("selectedItem");
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.choosePurchaseOrderItemWarehouseEvent, this.getBindingContext().getObject(), this.itemConditions(selectedItem));
                                                }
                                            },
                                            criteria: [
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchaseorderitem_unitprice"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpOnly: false,
                                            valueHelpIconSrc: "sap-icon://time-overtime",
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        ...
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.choosePurchaseOrderItemDistributionRuleEvent,
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchaseorderitem_distributionrule4"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.choosePurchaseOrderItemDistributionRuleEvent,
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchaseorderitem_distributionrule5"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.choosePurchaseOrderItemDistributionRuleEvent,
                    ...
                    let formBottom: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        ...
                        content: [
                            ...
                            new sap.m.Label("", {
                                text: ibas.i18n.prop("bo_purchaseorder_branch"),
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchaseorder_rounding") }),
                            new sap.m.FlexBox("", {
                                width: "100%",
                                justifyContent: sap.m.FlexJustifyContent.Start,
                                renderType: sap.m.FlexRendertype.Bare,
