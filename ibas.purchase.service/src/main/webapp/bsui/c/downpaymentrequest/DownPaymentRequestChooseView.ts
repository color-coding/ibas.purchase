...
namespace purchase {
    export namespace ui {
        export namespace c {
             ...
             * 选择视图-预付款申请
             */
            export class DownPaymentRequestChooseView extends ibas.BOQueryDialogViewWithPanel implements app.IDownPaymentRequestChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                    return bo.DownPaymentRequest;
                }
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_docentry"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_approvalstatus"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "approvalStatus",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_canceled"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "canceled",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_documentstatus"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "documentStatus",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_suppliercode"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "supplierCode",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_suppliername"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "supplierName",
                                    type: new sap.extension.data.Alphanumeric()
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_documentdate"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "documentDate",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_deliverydate"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "deliveryDate",
                                    type: new sap.extension.data.Date()
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_documenttotal"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "documentTotal",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_paidtotal"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "paidTotal",
                                    type: new sap.extension.data.Sum()
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_documentcurrency"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_ordertype"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_dataowner"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_reference1"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "reference1",
                                    type: new sap.extension.data.Alphanumeric()
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_downpaymentrequest_reference2"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "reference2",
                                    type: new sap.extension.data.Alphanumeric()
                    ...
                    this.itemTable = new sap.extension.m.DataTable("", {
                        ...
                        columns: [
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_downpaymentrequestitem_lineid"),
                                width: "6rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_downpaymentrequestitem_itemcode"),
                                width: "10rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_downpaymentrequestitem_itemdescription"),
                                width: "14rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_downpaymentrequestitem_warehouse"),
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_downpaymentrequestitem_quantity"),
                                width: "8rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_downpaymentrequestitem_price"),
                                width: "8rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_downpaymentrequestitem_linetotal"),
                                width: "8rem",
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_downpaymentrequestitem_reference1"),
                            }),
                            new sap.extension.m.Column("", {
                                header: ibas.i18n.prop("bo_downpaymentrequestitem_reference2"),
                            }),
                        ],
                        items: {
                            path: "/",
                                                    ...
                                                    menu: new sap.m.Menu("", {
                                                        items: [
                                                            this.customMenuItem = new sap.m.MenuItem("", {
                                                                ...
                                                                press: function (): void {
                                                                    let selecteds: ibas.IList<bo.DownPaymentRequest> = that.table.getSelecteds();
                                                    ...
                                                    press: function (): void {
                                                        ...
                                                        if (selectItems.length > 0) {
                                                            ...
                                                            for (let select of selects) {
                                                                for (let i: number = 0; i < select.downPaymentRequestItems.length; i++) {
                ...
                showDataItems(datas: bo.DownPaymentRequest[]): void {
                    this.container.to(this.itemTable.getParent().getId());
                    let dataItems: ibas.IList<bo.DownPaymentRequestItem> = new ibas.ArrayList<bo.DownPaymentRequestItem>();
