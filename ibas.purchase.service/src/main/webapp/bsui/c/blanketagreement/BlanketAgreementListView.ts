...
namespace purchase {
    export namespace ui {
        export namespace c {
            /** 列表视图-一揽子协议 */
            export class BlanketAgreementListView extends ibas.BOListView implements app.IBlanketAgreementListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                ...
                draw(): any {
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            ...
                            new sap.extension.table.DataColumn("", {
                                   label: ibas.i18n.prop("bo_blanketagreement_printed"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "printed",
                                    type: new sap.extension.data.YesNo(true)
