                ...
                draw(): any {
                    ...
                    let formTop: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        ...
                        content: [
                            ...
                            new sap.m.Label("", {
                                visible: false,
                                text: ibas.i18n.prop("bo_purchasereturn_postingdate"),
                            }),
                            new sap.extension.m.DatePicker("", {
                                visible: false,
                            }).bindProperty("bindingValue", {
                            ...
                            new sap.m.Label("", {
                                visible: false,
                                text: ibas.i18n.prop("bo_purchasereturn_consumer")
                            }),
                            new sap.extension.m.Input("", {
                                visible: false,
                            }).bindProperty("bindingValue", {
                        ...
                        content: [
                            ...
                            this.tablePurchaseReturnItem = new sap.extension.table.DataTable("", {
                                ...
                                toolbar: new sap.m.Toolbar("", {
                                    content: [
                                        new sap.m.MenuButton("", {
                                            ...
                                            defaultAction(): void {
                                                that.fireViewEvents(that.addPurchaseReturnItemEvent, 1);
                                            }
                                        }),
                                        new sap.m.Button("", {
                                ...
                                columns: [
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereturnitem_catalogcode"),
                                        template: new sap.extension.m.RepositoryInput("", {
                                            showValueHelp: true,
                                            valueHelpRequest: function (): void {
                                                that.fireViewEvents(that.choosePurchaseReturnItemMaterialCatalogEvent,
                                                    // 获取当前对象
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                let selectedItem: any = event.getParameter("selectedItem");
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.choosePurchaseReturnItemMaterialCatalogEvent, this.getBindingContext().getObject(), this.itemConditions(selectedItem));
                                                }
                                            },
                                                ...
                                                if (typeof data === "string") {
                                                    if (data?.indexOf("\n") > 0) {
                                                        sap.extension.tables.fillingCellsData(source, data,
                                                            (rowCount) => {
                                                                that.fireViewEvents(that.addPurchaseReturnItemEvent, rowCount);
                                                                return true;
                                                            },
                                                            (cell, value) => {
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        ...
                                        template: new sap.extension.m.RepositoryInput("", {
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                let selectedItem: any = event.getParameter("selectedItem");
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.choosePurchaseReturnItemMaterialEvent, this.getBindingContext().getObject(), null, this.itemConditions(selectedItem));
                                                }
                                            },
                                            criteria: [
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        ...
                                        template: new sap.extension.m.RepositoryInput("", {
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                let selectedItem: any = event.getParameter("selectedItem");
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.choosePurchaseReturnItemWarehouseEvent, this.getBindingContext().getObject(), this.itemConditions(selectedItem));
                                                }
                                            },
                                            criteria: [
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        ...
                                        template: new sap.extension.m.RepositoryInput("", {
                                            ...
                                            suggestionItemSelected: function (this: sap.extension.m.RepositoryInput, event: sap.ui.base.Event): void {
                                                let selectedItem: any = event.getParameter("selectedItem");
                                                if (!ibas.objects.isNull(selectedItem)) {
                                                    that.fireViewEvents(that.choosePurchaseReturnItemUnitEvent, this.getBindingContext().getObject(), this.itemConditions(selectedItem));
                                                }
                                            },
                                            criteria: [
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereturnitem_tax"),
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereturnitem_pretaxprice"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpOnly: false,
                                            valueHelpIconSrc: "sap-icon://time-overtime",
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereturnitem_unitprice"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpOnly: false,
                                            valueHelpIconSrc: "sap-icon://time-overtime",
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        ...
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.choosePurchaseReturnItemDistributionRuleEvent,
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereturnitem_distributionrule4"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.choosePurchaseReturnItemDistributionRuleEvent,
                                    ...
                                    new sap.extension.table.DataColumn("", {
                                        label: ibas.i18n.prop("bo_purchasereturnitem_distributionrule5"),
                                        template: new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest(): void {
                                                that.fireViewEvents(that.choosePurchaseReturnItemDistributionRuleEvent,
                    ...
                    let formBottom: sap.ui.layout.form.SimpleForm = new sap.ui.layout.form.SimpleForm("", {
                        ...
                        content: [
                            ...
                            new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasereturn_rounding") }),
                            new sap.m.FlexBox("", {
                                width: "100%",
                                justifyContent: sap.m.FlexJustifyContent.Start,
                                renderType: sap.m.FlexRendertype.Bare,
                                    ...
                                    menu: new sap.m.Menu("", {
                                        items: [
                                            new sap.m.MenuItem("", {
                                                ...
                                                press: function (): void {
                                                    let data: any = this.getBindingContext().getObject();
                                                    if (data instanceof bo.PurchaseReturn) {
                                                        let criteria: ibas.ICriteria = new ibas.Criteria();
                                                        criteria.result = 1;
                                                        let condition: ibas.ICondition = criteria.conditions.create();
