    ...
    export namespace ui {
        export namespace m {
            ...
            export class DownPaymentRequestViewView extends ibas.BOViewView implements app.IDownPaymentRequestViewView {
                                                        ...
                                                        parts: [
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                formatter(data: ibas.emYesNo): string {
                                                                    return ibas.emYesNo.YES === data ? ibas.i18n.prop("bo_downpaymentrequest_canceled") : "";
                                                                },
                                                            },
                                                        ]
                                                    }),
                                                ...
                                                items: {
                                                    ...
                                                    template: new sap.extension.m.DataObjectListItem("", {
                                                        ...
                                                        press: function (oEvent: sap.ui.base.Event): void {
                                                            that.viewDownPaymentRequestItem(this.getBindingContext().getObject());
                                                        },
                                                    })
                                                }
                                            }).addStyleClass("sapUxAPObjectPageSubSectionAlignContent"),
                ...
                /** 编辑数据行（预付款申请-行） */
                viewDownPaymentRequestItem(data: bo.DownPaymentRequestItem): void {
                    let that: this = this;
