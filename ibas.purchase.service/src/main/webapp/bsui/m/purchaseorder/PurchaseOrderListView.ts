                                    ...
                                    items: [
                                        new sap.m.SegmentedButtonItem("", {
                                            ...
                                            press: function (event: sap.ui.base.Event): void {
                                                ...
                                                for (let item of that.list.getSelecteds<bo.PurchaseOrder>()) {
                                                    criteria.result++;
                        ...
                        items: {
                            ...
                            template: new sap.extension.m.DataObjectListItem("", {
                                ...
                                attributes: [
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchaseorder_suppliercode"),
                                        bindingValue: {
                                            path: "supplierCode",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchaseorder_suppliername"),
                                        bindingValue: {
                                            path: "supplierName",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
