    ...
    export namespace ui {
        export namespace m {
            ...
            export class PurchaseCreditNoteEditView extends ibas.BOEditView implements app.IPurchaseCreditNoteEditView {
                    ...
                    return this.page = new sap.extension.uxap.DataObjectPageLayout("", {
                        ...
                        sectionChange(event: sap.ui.base.Event): void {
                            ...
                            if (section instanceof sap.uxap.ObjectPageSection) {
                                if (section.getTitle() === ibas.i18n.prop("bo_purchasecreditnoteitem")) {
                        ...
                        headerContent: [
                            new sap.extension.m.ObjectApprovalStatus("", {
                                title: ibas.i18n.prop("bo_purchasecreditnote_approvalstatus"),
                                enumValue: {
                                    path: "approvalStatus",
                            ...
                            new sap.extension.m.ObjectDocumentCanceledStatus("", {
                                title: ibas.i18n.prop("bo_purchasecreditnote_documentstatus"),
                                canceledStatus: {
                                    path: "canceled",
                            ...
                            new sap.extension.m.ObjectAttribute("", {
                                title: ibas.i18n.prop("bo_purchasecreditnote_documentdate"),
                                bindingValue: {
                                    path: "documentDate",
                            ...
                            new sap.extension.m.ObjectAttribute("", {
                                title: ibas.i18n.prop("bo_purchasecreditnote_documenttotal"),
                                bindingValue: {
                                    parts: [
                                        {
                                            path: "documentTotal",
                        ...
                        sections: [
                            ...
                            new sap.uxap.ObjectPageSection("", {
                                title: ibas.i18n.prop("bo_purchasecreditnoteitem"),
                                subSections: [
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            this.listPurchaseCreditNoteItem = new sap.extension.m.List("", {
                                                inset: false,
                                                growing: false,
                                                width: "auto",
                                                            ...
                                                            items: [
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    ...
                                                                    press(oEvent: any): void {
                                                                        that.fireViewEvents(that.addPurchaseCreditNoteItemEvent, that.listPurchaseCreditNoteItem.getSelecteds());
                                                                    }
                                                                }),
                                                                new sap.m.SegmentedButtonItem("", {
                                                                    width: "3rem",
                                                                    icon: "sap-icon://delete",
                                                                    press(oEvent: any): void {
                                                                        that.fireViewEvents(that.removePurchaseCreditNoteItemEvent, that.listPurchaseCreditNoteItem.getSelecteds());
                                                                    }
                                                                }),
                                                            ]
                                                        }),
                                                ...
                                                items: {
                                                    ...
                                                    template: new sap.extension.m.DataObjectListItem("", {
                                                        ...
                                                        attributes: [
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_purchasecreditnoteitem_quantity"),
                                                                bindingValue: {
                                                                    parts: [
                                                                        {
                                                                            path: "quantity",
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_purchasecreditnoteitem_price"),
                                                                bindingValue: {
                                                                    parts: [
                                                                        {
                                                                            path: "price",
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_purchasecreditnoteitem_linetotal"),
                                                                bindingValue: {
                                                                    parts: [
                                                                        {
                                                                            path: "lineTotal",
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_purchasecreditnoteitem_reference1"),
                                                                bindingValue: {
                                                                    path: "reference1",
                                                                    type: new sap.extension.data.Alphanumeric(),
                                                                }
                                                            ...
                                                            new sap.extension.m.ObjectAttribute("", {
                                                                title: ibas.i18n.prop("bo_purchasecreditnoteitem_reference2"),
                                                                bindingValue: {
                                                                    path: "reference2",
                                                                    type: new sap.extension.data.Alphanumeric(),
                                                                }
                                                        ...
                                                        press: function (oEvent: sap.ui.base.Event): void {
                                                            that.editPurchaseCreditNoteItem(this.getBindingContext().getObject());
                                                        },
                                                    })
                                                },
                                            }).addStyleClass("sapUxAPObjectPageSubSectionAlignContent"),
                ...
                private listPurchaseCreditNoteItem: sap.extension.m.List;
                ...
                showPurchaseCreditNoteItems(datas: bo.PurchaseCreditNoteItem[]): void {
                    this.listPurchaseCreditNoteItem.setModel(new sap.extension.model.JSONModel({ rows: datas }));
                }
                /** 编辑数据（采购贷项-行） */
                editPurchaseCreditNoteItem(data: bo.PurchaseCreditNoteItem): void {
                    let that: this = this;
                    ...
                    if (!(editForm instanceof sap.m.Dialog)) {
                        editForm = new sap.m.Dialog(this.id + "_editform", {
                            title: ibas.strings.format("{0} - {1}", ibas.i18n.prop("bo_purchasecreditnoteitem"), data.lineId),
                            ...
                            content: [
                                new sap.extension.layout.DataSimpleForm("", {
                                    ...
                                    content: [
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasecreditnoteitem_lineid") }),
                                        new sap.extension.m.Input("", {
                                            editable: false,
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasecreditnoteitem_linestatus") }),
                                        new sap.extension.m.EnumSelect("", {
                                            enumType: ibas.emDocumentStatus
                                        }).bindProperty("bindingValue", {
                                            path: "lineStatus",
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasecreditnoteitem_itemcode") }),
                                        new sap.extension.m.Input("", {
                                            showValueHelp: true,
                                            valueHelpRequest: function (this: sap.extension.m.Input): void {
                                                ...
                                                if (model instanceof sap.extension.model.JSONModel) {
                                                    ...
                                                    if (data) {
                                                        that.fireViewEvents(that.choosePurchaseCreditNoteItemMaterialEvent, data);
                                                    }
                                                }
                                            },
                                            showValueLink: true,
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasecreditnoteitem_itemdescription") }),
                                        new sap.extension.m.Input("", {
                                            editable: false,
                                        }).bindProperty("bindingValue", {
                                        ...
                                        new sap.m.Label("", {
                                            text: ibas.i18n.prop("bo_purchasecreditnoteitem_itemversion"),
                                        ...
                                        new sap.extension.m.RepositoryInput("", {
                                            ...
                                            valueHelpRequest: function (this: sap.extension.m.Input): void {
                                                ...
                                                if (model instanceof sap.extension.model.JSONModel) {
                                                    let data: any = model.getData();
                                                    if (data) {
                                                        that.fireViewEvents(that.choosePurchaseCreditNoteItemWarehouseEvent, data);
                                                    }
                                                }
                                            }
                                        }).bindProperty("bindingValue", {
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasecreditnoteitem_quantity") }),
                                        new sap.m.FlexBox("", {
                                            width: "100%",
                                            justifyContent: sap.m.FlexJustifyContent.Start,
                                            renderType: sap.m.FlexRendertype.Bare,
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasecreditnoteitem_price") }),
                                        new sap.extension.m.Input("", {
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasecreditnoteitem_linetotal") }),
                                        new sap.extension.m.Input("", {
                                            editable: true,
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasecreditnoteitem_tax") }),
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasecreditnoteitem_reference1") }),
                                        new sap.extension.m.Input("", {
                                        }).bindProperty("bindingValue", {
                                            path: "reference1",
                                            type: new sap.extension.data.Alphanumeric({
                                        ...
                                        new sap.m.Label("", { text: ibas.i18n.prop("bo_purchasecreditnoteitem_reference2") }),
                                        new sap.extension.m.Input("", {
                                        }).bindProperty("bindingValue", {
                                            path: "reference2",
                                            type: new sap.extension.data.Alphanumeric({
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (): void {
                                        ...
                                        if (form instanceof sap.extension.layout.SimpleForm) {
                                            let datas: any = that.listPurchaseCreditNoteItem.getModel().getData("rows");
                                            if (datas instanceof Array && datas.length > 0) {
                                                ...
                                                editForm.setTitle(ibas.strings.format("{0} - {1}", ibas.i18n.prop("bo_purchasecreditnoteitem"), datas[index].lineId));
                                            } else {
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (): void {
                                        ...
                                        if (form instanceof sap.extension.layout.SimpleForm) {
                                            let datas: any = that.listPurchaseCreditNoteItem.getModel().getData("rows");
                                            if (datas instanceof Array && datas.length > 0) {
                                                that.fireViewEvents(that.removePurchaseCreditNoteItemEvent, form.getModel().getData());
                                                if (datas.length === 1) {
                                                    // 无数据，退出
