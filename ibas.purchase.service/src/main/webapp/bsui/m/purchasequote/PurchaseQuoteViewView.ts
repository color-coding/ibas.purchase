    ...
    export namespace ui {
        export namespace m {
            ...
            export class PurchaseQuoteViewView extends ibas.BOViewView implements app.IPurchaseQuoteViewView {
                                                ...
                                                items: {
                                                    ...
                                                    template: new sap.m.ObjectListItem("", {
                                                        ...
                                                        press: function (oEvent: sap.ui.base.Event): void {
                                                            that.viewPurchaseQuoteItem(this.getBindingContext().getObject());
                                                        },
                                                    })
                                                }
                                            }).addStyleClass("sapUxAPObjectPageSubSectionAlignContent"),
                ...
                /** 编辑数据行（采购报价-行） */
                viewPurchaseQuoteItem(data: bo.PurchaseQuoteItem): void {
                    let that: this = this;
                    let editForm: sap.m.Dialog = new sap.m.Dialog("", {
                        title: {
                            ...
                            formatter(data: string): string {
                                return ibas.strings.format("{0} - {1}", ibas.i18n.prop("bo_purchasequoteitem"), data);
                            }
                        },
