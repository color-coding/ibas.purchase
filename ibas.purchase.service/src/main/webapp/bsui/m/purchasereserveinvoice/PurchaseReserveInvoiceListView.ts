                                    ...
                                    items: [
                                        new sap.m.SegmentedButtonItem("", {
                                            ...
                                            press: function (event: sap.ui.base.Event): void {
                                                ...
                                                for (let item of that.list.getSelecteds<bo.PurchaseReserveInvoice>()) {
                                                    criteria.result++;
                        ...
                        items: {
                            ...
                            template: new sap.extension.m.DataObjectListItem("", {
                                ...
                                attributes: [
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchasereserveinvoice_suppliercode"),
                                        bindingValue: {
                                            path: "supplierCode",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchasereserveinvoice_suppliername"),
                                        bindingValue: {
                                            path: "supplierName",
                                            type: new sap.extension.data.Alphanumeric(),
                                        }
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: ibas.i18n.prop("bo_purchasereserveinvoice_consumer"),
                                        bindingValue: {
                                            path: "consumer",
                                            type: new sap.extension.data.Alphanumeric(),
                                        },
