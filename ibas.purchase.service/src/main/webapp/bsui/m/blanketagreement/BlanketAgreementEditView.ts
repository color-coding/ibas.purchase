                ...
                draw(): any {
                    ...
                    return this.page = new sap.extension.uxap.DataObjectPageLayout("", {
                        ...
                        sections: [
                                    ...
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            new sap.ui.layout.form.SimpleForm("", {
                                                ...
                                                width: "auto",
                                                content: [
                                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_blanketagreement_suppliercode") }),
                                                    new sap.extension.m.Input("", {
                                                        showValueHelp: true,
                                                        valueHelpRequest: function (): void {
                                                            that.fireViewEvents(that.chooseBlanketAgreementSupplierEvent);
                                                        },
                                                        showValueLink: true,
                                                    ...
                                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_blanketagreement_suppliername") }),
                                                    new sap.extension.m.Input("", {
                                                        editable: false,
                                                    }).bindProperty("bindingValue", {
                                                        path: "supplierName",
                                                    ...
                                                    new sap.m.FlexBox("", {
                                                        ...
                                                        items: [
                                                            ...
                                                            new sap.extension.m.CheckBox("", {
                                                                text: ibas.i18n.prop("bo_blanketagreement_printed"),
                                                                editable: false,
                                                            }).bindProperty("bindingValue", {
                                                                path: "printed",
                                                                type: new sap.extension.data.YesNo()
                            ...
                            new sap.uxap.ObjectPageSection("", {
                                title: ibas.i18n.prop("purchase_title_clauses"),
                                subSections: [
                                    new sap.uxap.ObjectPageSubSection("", {
                                        blocks: [
                                            new sap.ui.layout.form.SimpleForm("", {
