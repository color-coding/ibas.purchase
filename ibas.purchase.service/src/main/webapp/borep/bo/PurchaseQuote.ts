...
namespace purchase {
    export namespace bo {
        ...
        export class PurchaseQuote extends ibas.BODocument<PurchaseQuote> implements IPurchaseQuote, ibas.IConvertedData {
            ...
            /** 获取-单据编码 */
            get docNum(): string {
                return this.getProperty<string>(PurchaseQuote.PROPERTY_DOCNUM_NAME);
            }
            /** 设置-单据编码 */
            ...
            get printed(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(PurchaseQuote.PROPERTY_PRINTED_NAME);
            }
            /** 设置-已打印 */
            set printed(value: ibas.emYesNo) {
                this.setProperty(PurchaseQuote.PROPERTY_PRINTED_NAME, value);
            }
            ...
            get agreements(): string {
                return this.getProperty<string>(PurchaseQuote.PROPERTY_AGREEMENTS_NAME);
            }
            /** 设置-合同 */
            ...
            get itemsPreTaxTotal(): number {
                return this.getProperty<number>(PurchaseQuote.PROPERTY_ITEMSPRETAXTOTAL_NAME);
            }
            /** 设置-项目的税前行总计 */
            set itemsPreTaxTotal(value: number) {
                this.setProperty(PurchaseQuote.PROPERTY_ITEMSPRETAXTOTAL_NAME, value);
            }
            ...
            reset(): void {
                ...
                this.paidTotal = 0;
                this.documentStatus = ibas.emDocumentStatus.RELEASED;
                this.purchaseQuoteItems.forEach(c => c.lineStatus = ibas.emDocumentStatus.RELEASED);
            }
            /** 转换之前 */
            beforeConvert(): void { }
            /** 数据解析后 */
        ...
        export class PurchaseQuoteItem extends ibas.BODocumentLine<PurchaseQuoteItem> implements IPurchaseQuoteItem {
            ...
            get catalogCode(): string {
                return this.getProperty<string>(PurchaseQuoteItem.PROPERTY_CATALOGCODE_NAME);
            }
            /** 设置-目录编码 */
            set catalogCode(value: string) {
                this.setProperty(PurchaseQuoteItem.PROPERTY_CATALOGCODE_NAME, value);
            }
            ...
            get itemVersion(): string {
                return this.getProperty<string>(PurchaseQuoteItem.PROPERTY_ITEMVERSION_NAME);
            }
            /** 设置-物料版本 */
            set itemVersion(value: string) {
                this.setProperty(PurchaseQuoteItem.PROPERTY_ITEMVERSION_NAME, value);
            }
            ...
            get inventoryUOM(): string {
                return this.getProperty<string>(PurchaseQuoteItem.PROPERTY_INVENTORYUOM_NAME);
            }
            /** 设置-库存单位 */
            set inventoryUOM(value: string) {
                this.setProperty(PurchaseQuoteItem.PROPERTY_INVENTORYUOM_NAME, value);
            }
            ...
            /** 获取-单位换算率 */
            get uomRate(): number {
                return this.getProperty<number>(PurchaseQuoteItem.PROPERTY_UOMRATE_NAME);
            }
            /** 设置-单位换算率 */
            set uomRate(value: number) {
                this.setProperty(PurchaseQuoteItem.PROPERTY_UOMRATE_NAME, value);
            }
            ...
            get inventoryQuantity(): number {
                return this.getProperty<number>(PurchaseQuoteItem.PROPERTY_INVENTORYQUANTITY_NAME);
            }
            /** 设置-库存数量 */
            set inventoryQuantity(value: number) {
                this.setProperty(PurchaseQuoteItem.PROPERTY_INVENTORYQUANTITY_NAME, value);
            }
            ...
            /** 获取-合同 */
            get agreements(): string {
                return this.getProperty<string>(PurchaseQuoteItem.PROPERTY_AGREEMENTS_NAME);
            }
            /** 设置-合同 */
            set agreements(value: string) {
            ...
            /** 获取-价格（本币） */
            get priceLC(): number {
                return this.getProperty<number>(PurchaseQuoteItem.PROPERTY_PRICELC_NAME);
            }
            /** 设置-价格（本币） */
            set priceLC(value: number) {
                this.setProperty(PurchaseQuoteItem.PROPERTY_PRICELC_NAME, value);
            }
            ...
            get unitPriceLC(): number {
                return this.getProperty<number>(PurchaseQuoteItem.PROPERTY_UNITPRICELC_NAME);
            }
            /** 设置-折扣前价格（本币） */
            set unitPriceLC(value: number) {
                this.setProperty(PurchaseQuoteItem.PROPERTY_UNITPRICELC_NAME, value);
            }
            ...
            get preTaxPriceLC(): number {
                return this.getProperty<number>(PurchaseQuoteItem.PROPERTY_PRETAXPRICELC_NAME);
            }
            /** 设置-税前价格（本币） */
            set preTaxPriceLC(value: number) {
                this.setProperty(PurchaseQuoteItem.PROPERTY_PRETAXPRICELC_NAME, value);
            }
            ...
            protected registerRules(): ibas.IBusinessRule[] {
                return [
                    ...
                    new BusinessRuleDeductionCurrencyAmount(
                        PurchaseQuoteItem.PROPERTY_UNITPRICELC_NAME, PurchaseQuoteItem.PROPERTY_UNITPRICE_NAME, PurchaseQuoteItem.PROPERTY_RATE_NAME
                    ),
                    new BusinessRuleDeductionCurrencyAmount(
                        PurchaseQuoteItem.PROPERTY_PRETAXPRICELC_NAME, PurchaseQuoteItem.PROPERTY_PRETAXPRICE_NAME, PurchaseQuoteItem.PROPERTY_RATE_NAME
                    ),
                    new BusinessRuleDeductionCurrencyAmount(
                        PurchaseQuoteItem.PROPERTY_PRICELC_NAME, PurchaseQuoteItem.PROPERTY_PRICE_NAME, PurchaseQuoteItem.PROPERTY_RATE_NAME
                    ),
                    // 计算库存数量 = 数量 * 换算率
                    ...
                    new BusinessRuleDeductionPriceQtyTotal(
                        PurchaseQuoteItem.PROPERTY_UNITLINETOTAL_NAME, PurchaseQuoteItem.PROPERTY_UNITPRICE_NAME,
                        config.isInventoryUnitLinePrice() ? PurchaseQuoteItem.PROPERTY_INVENTORYQUANTITY_NAME : PurchaseQuoteItem.PROPERTY_QUANTITY_NAME
                    ),
                    // 计算 行总计 = 税前总计（折扣后） + 税总计；行总计 = 价格（税后） * 数量；税总计 = 税前总计（折扣后） * 税率
                    new BusinessRuleDeductionPriceTaxTotal(PurchaseQuoteItem.PROPERTY_LINETOTAL_NAME, PurchaseQuoteItem.PROPERTY_PRICE_NAME,
                        config.isInventoryUnitLinePrice() ? PurchaseQuoteItem.PROPERTY_INVENTORYQUANTITY_NAME : PurchaseQuoteItem.PROPERTY_QUANTITY_NAME,
                        PurchaseQuoteItem.PROPERTY_TAXRATE_NAME, PurchaseQuoteItem.PROPERTY_TAXTOTAL_NAME, PurchaseQuoteItem.PROPERTY_PRETAXLINETOTAL_NAME
                    ),
                    // 计算折扣后总计（税前） = 数量 * 折扣后价格（税前）
                    new BusinessRuleDeductionPriceQtyTotal(
                        PurchaseQuoteItem.PROPERTY_PRETAXLINETOTAL_NAME, PurchaseQuoteItem.PROPERTY_PRETAXPRICE_NAME,
                        config.isInventoryUnitLinePrice() ? PurchaseQuoteItem.PROPERTY_INVENTORYQUANTITY_NAME : PurchaseQuoteItem.PROPERTY_QUANTITY_NAME
                    ),
                    // 计算折扣后总计 = 折扣前总计 * 折扣
