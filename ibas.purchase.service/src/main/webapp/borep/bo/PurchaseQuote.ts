            ...
            protected registerRules(): ibas.IBusinessRule[] {
                return [
                    ...
                    new BusinessRuleDeductionPriceQtyTotal(
                        PurchaseQuoteItem.PROPERTY_UNITLINETOTAL_NAME, PurchaseQuoteItem.PROPERTY_UNITPRICE_NAME, PurchaseQuoteItem.PROPERTY_INVENTORYQUANTITY_NAME
                    ),
                    // 计算 行总计 = 税前总计（折扣后） + 税总计；行总计 = 价格（税后） * 数量；税总计 = 税前总计（折扣后） * 税率
                    new BusinessRuleDeductionPriceTaxTotal(PurchaseQuoteItem.PROPERTY_LINETOTAL_NAME, PurchaseQuoteItem.PROPERTY_PRICE_NAME, PurchaseQuoteItem.PROPERTY_INVENTORYQUANTITY_NAME
                    ...
                    new BusinessRuleDeductionPriceQtyTotal(
                        PurchaseQuoteItem.PROPERTY_PRETAXLINETOTAL_NAME, PurchaseQuoteItem.PROPERTY_PRETAXPRICE_NAME, PurchaseQuoteItem.PROPERTY_INVENTORYQUANTITY_NAME
                    ),
                    // 计算折扣后总计 = 折扣前总计 * 折扣
