...
namespace purchase {
    export namespace bo {
        ...
        export class PurchaseInvoice extends ibas.BODocument<PurchaseInvoice> implements IPurchaseInvoice, ibas.IConvertedData {
            ...
            /** 获取-期间编号 */
            get docNum(): number {
                return this.getProperty<number>(PurchaseInvoice.PROPERTY_DOCNUM_NAME);
            }
            /** 设置-期间编号 */
            ...
            protected registerRules(): ibas.IBusinessRule[] {
                return [
                    ...
                    new BusinessRuleDeductionDocumentTotal(PurchaseInvoice.PROPERTY_DOCUMENTTOTAL_NAME,
                        PurchaseInvoice.PROPERTY_DISCOUNTTOTAL_NAME, PurchaseInvoice.PROPERTY_SHIPPINGSEXPENSETOTAL_NAME),
                ];
            }
            /** 重置 */
            reset(): void {
            ...
            protected registerRules(): ibas.IBusinessRule[] {
                return [
                    ...
                    new BusinessRuleDeductionPriceQtyTotal(
                        PurchaseInvoiceItem.PROPERTY_UNITLINETOTAL_NAME, PurchaseInvoiceItem.PROPERTY_UNITPRICE_NAME, PurchaseInvoiceItem.PROPERTY_INVENTORYQUANTITY_NAME
                    ),
                    // 计算 行总计 = 税前总计（折扣后） + 税总计；行总计 = 价格（税后） * 数量；税总计 = 税前总计（折扣后） * 税率
                    new BusinessRuleDeductionPriceTaxTotal(PurchaseInvoiceItem.PROPERTY_LINETOTAL_NAME, PurchaseInvoiceItem.PROPERTY_PRICE_NAME, PurchaseInvoiceItem.PROPERTY_INVENTORYQUANTITY_NAME
                    ...
                    new BusinessRuleDeductionPriceQtyTotal(
                        PurchaseInvoiceItem.PROPERTY_PRETAXLINETOTAL_NAME, PurchaseInvoiceItem.PROPERTY_PRETAXPRICE_NAME, PurchaseInvoiceItem.PROPERTY_INVENTORYQUANTITY_NAME
                    ),
                    // 计算折扣后总计 = 折扣前总计 * 折扣
