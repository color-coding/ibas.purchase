            ...
            protected registerRules(): ibas.IBusinessRule[] {
                return [
                    ...
                    new BusinessRuleDeductionPriceQtyTotal(
                        PurchaseReturnItem.PROPERTY_UNITLINETOTAL_NAME, PurchaseReturnItem.PROPERTY_UNITPRICE_NAME, PurchaseReturnItem.PROPERTY_INVENTORYQUANTITY_NAME
                    ),
                    // 计算 行总计 = 税前总计（折扣后） + 税总计；行总计 = 价格（税后） * 数量；税总计 = 税前总计（折扣后） * 税率
                    new BusinessRuleDeductionPriceTaxTotal(PurchaseReturnItem.PROPERTY_LINETOTAL_NAME, PurchaseReturnItem.PROPERTY_PRICE_NAME, PurchaseReturnItem.PROPERTY_INVENTORYQUANTITY_NAME
                    ...
                    new BusinessRuleDeductionPriceQtyTotal(
                        PurchaseReturnItem.PROPERTY_PRETAXLINETOTAL_NAME, PurchaseReturnItem.PROPERTY_PRETAXPRICE_NAME, PurchaseReturnItem.PROPERTY_INVENTORYQUANTITY_NAME
                    ),
                    // 计算折扣后总计 = 折扣前总计 * 折扣
