...
namespace purchase {
    export namespace bo {
        /** 采购预留发票 */
        export interface IPurchaseReserveInvoice extends ibas.IBODocument, ibas.IBOUserFields {
            /** 凭证编号 */
            docEntry: number;
            /** 单据编码 */
            docNum: string;
        ...
        /** 采购预留发票-行 集合 */
        export interface IPurchaseReserveInvoiceItems extends ibas.IBusinessObjects<IPurchaseReserveInvoiceItem> {
            /** 创建并添加子项 */
            create(): IPurchaseReserveInvoiceItem;
        }

        /** 采购预留发票-行 */
        export interface IPurchaseReserveInvoiceItem extends ibas.IBODocumentLine, materials.bo.IMaterialBatchItemParent, materials.bo.IMaterialSerialItemParent, ibas.IBOUserFields {
            /** 编码 */
            docEntry: number;
            /** 行号 */
            lineId: number;
