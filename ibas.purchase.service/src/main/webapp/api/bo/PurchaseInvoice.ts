...
namespace purchase {
    export namespace bo {
        /** 采购发票 */
        export interface IPurchaseInvoice extends ibas.IBODocument, ibas.IBOUserFields {
            /** 凭证编号 */
            docEntry: number;
            /** 期间编号 */
            docNum: number;
        ...
        /** 采购发票-行 集合 */
        export interface IPurchaseInvoiceItems extends ibas.IBusinessObjects<IPurchaseInvoiceItem> {
            /** 创建并添加子项 */
