...
namespace purchase {
    export namespace bo {
        /** 采购退货请求 */
        export interface IPurchaseReturnRequest extends ibas.IBODocument, ibas.IBOUserFields {
        ...
        /** 采购退货请求-行 集合 */
        export interface IPurchaseReturnRequestItems extends ibas.IBusinessObjects<IPurchaseReturnRequestItem> {
        ...
        /** 采购退货请求-行 */
        export interface IPurchaseReturnRequestItem extends ibas.IBODocumentLine, materials.bo.IMaterialBatchItemParent, materials.bo.IMaterialSerialItemParent, ibas.IBOUserFields {
