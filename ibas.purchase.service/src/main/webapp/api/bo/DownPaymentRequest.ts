...
namespace purchase {
    export namespace bo {
        /** 预付款申请 */
        export interface IDownPaymentRequest extends ibas.IBODocument, ibas.IBOUserFields {
            /** 凭证编号 */
            docEntry: number;
            /** 单据编码 */
            docNum: string;
        ...
        /** 预付款申请-行 集合 */
        export interface IDownPaymentRequestItems extends ibas.IBusinessObjects<IDownPaymentRequestItem> {
            /** 创建并添加子项 */
            create(): IDownPaymentRequestItem;
        }

        /** 预付款申请-行 */
        export interface IDownPaymentRequestItem extends ibas.IBODocumentLine, ibas.IBOUserFields {
            /** 凭证编号 */
            docEntry: number;
            /** 行号 */
            lineId: number;
