...
namespace purchase {
    export namespace bo {
        /** 采购贷项 */
        export interface IPurchaseCreditNote extends ibas.IBODocument, ibas.IBOUserFields {
            /** 凭证编号 */
            docEntry: number;
            /** 单据编码 */
            docNum: string;
        ...
        /** 采购贷项-行 集合 */
        export interface IPurchaseCreditNoteItems extends ibas.IBusinessObjects<IPurchaseCreditNoteItem> {
            /** 创建并添加子项 */
            create(): IPurchaseCreditNoteItem;
        }

        /** 采购贷项-行 */
        export interface IPurchaseCreditNoteItem extends ibas.IBODocumentLine, ibas.IBOUserFields {
            /** 编码 */
            docEntry: number;
            /** 行号 */
            lineId: number;
